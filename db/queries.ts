...
export const getLesson = cache(async (id?: number) => {
  ...
  const normalizedChallenges = data.challenges.map((challenge) => {  // Se obtiene cada reto de la activeLesson (o leccion desde arg id) y de cada reto obtendremos
  ...
  return { ...data, challenges: normalizedChallenges } // Se devuelve la lesson de la id del parámetro o de la activeLesson con los retos actualizados
})
